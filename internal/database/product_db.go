...
func (pd *ProductDB) CreateProducts(product *entity.Product) (string, error) {
	_, err := pd.db.Exec("INSERT INTO products (id, name, price, category_id, image_url) VALUES (?,?,?,?,?)", product)
